...
public static class SharedExtensions
{
    ...
    public static int GenerateTypeHeader(this INamedTypeSymbol type, StringBuilder sb)
    {
    ...
    public static string GetSimplifiedTypeName(this ITypeSymbol type)
    {
    ...
    public static bool TryGetSpecialTypeKeyword(this ITypeSymbol type, out string keyword)
    {
    ...
    public static string SnakeIdToPascal(this string str)
    {
