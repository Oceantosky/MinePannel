...
#Region "页面事件"
    ...
    ''' <summary>为单个实例标记云同步（入口 B：版本选择页按钮）</summary>
    Private Shared Sub MarkSingleInstanceToCloud(instance As McInstance)
    ...
    Private Shared Sub DoMarkSingleInstance(instance As McInstance)
        ...
        Sub()
            Try
                    ...
                    Sub()
                        Try
                            ...
                            If MyMsgBox(msg, "发现可同步的云端实例", "标记", "取消") = 1 Then
                                ...
                                RunInNewThread(
                                Sub()
                                    Dim success = ModCloudDiscovery.MarkAsCloudManaged(instance.PathInstance, cloudInfo)
                                    RunInUi(
                                    Sub()
                                        If success Then
                ...
                Else
                    ...
                    Sub()
                        Try
                            ...
                            Next
                            Dim selectedIndex As Integer? = MyMsgBoxSelect(selections, "选择要绑定的云端实例",
                                "绑定", "取消")
                            If selectedIndex.HasValue Then
                                ...
                                Sub()
                                    ...
                                    Sub()
                                        ...
                                        End If
                                    End Sub)
                                End Sub, "Cloud Mark Single Manual")
                            End If
                        Finally
                            waitHandle.Set()
                        End Try
                ...
                End If
            Catch ex As Exception
                Log(ex, "[CloudUI] MarkSingleInstanceToCloud 异常")
                RunInUi(Sub() Hint("标记过程发生异常，请查看日志", HintType.Critical))
            End Try
        End Sub, "Cloud Mark Single Instance")
    End Sub
