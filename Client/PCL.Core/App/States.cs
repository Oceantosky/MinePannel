...
public static partial class States
{
    ...
    /// 自定义变量。
    /// </summary>
    [AnyConfigItem<Dictionary<string, string>>("CustomVariables", ConfigSource.Shared)] public static partial Dictionary<string, string> CustomVariables { get; set; }
    ...
    [ConfigGroup("Game")] partial class GameStatesGroup
    {
        ...
        /// 当前实例。
        /// </summary>
        [ConfigItem<string>("LaunchInstanceSelect", "", ConfigSource.Shared)] public partial string SelectedInstance { get; set; }

        /// <summary>
        /// 当前文件夹。
        /// </summary>
        [ConfigItem<string>("LaunchFolderSelect", "", ConfigSource.Shared)] public partial string SelectedFolder { get; set; }
    ...
    [ConfigGroup("UI")] partial class UiStatesGroup
    {
        ...
        /// 窗口高度。
        /// </summary>
        [ConfigItem<double>("WindowHeight", 550, ConfigSource.Shared)] public partial double WindowHeight { get; set; }

        /// <summary>
        /// 窗口宽度。
        /// </summary>
        [ConfigItem<double>("WindowWidth", 900, ConfigSource.Shared)] public partial double WindowWidth { get; set; }
    ...
    [ConfigGroup("System")] partial class SystemStatesGroup
    {
        ...
        /// 本地配置版本。
        /// </summary>
        [ConfigItem<int>("SystemSetupVersionIni", 1, ConfigSource.Shared)] public partial int SetupVersionLocal { get; set; }

        /// <summary>
        /// 启动器公告。
        /// </summary>
        [ConfigItem<int>("SystemSystemActivity", 0, ConfigSource.Shared)] public partial int AnnounceSolution { get; set; }
