...
public static partial class Config
{
    ...
    {
        [ConfigItem<bool>("SystemNetEnableDoH", false)] public partial bool EnableDoH { get; set; }
    ...
    /// 云端连接配置。
    /// </summary>
    [ConfigGroup("Cloud", ConfigSource.SharedEncrypt)] partial class CloudConfigGroup
    {
        /// <summary>
        /// 设备绑定后存储的 binding_token。
        /// </summary>
        [ConfigItem<string>("CloudBindingToken", "", ConfigSource.SharedEncrypt)] public partial string BindingToken { get; set; }

        /// <summary>
        /// SRV 解析后的 CloudAbroad 服务端地址。
        /// </summary>
        [ConfigItem<string>("CloudServerUrl", "")] public partial string ServerUrl { get; set; }

        /// <summary>
        /// 上次成功连接的域名。
        /// </summary>
        [ConfigItem<string>("CloudLastDomain", "")] public partial string LastDomain { get; set; }
